...
class ChainBuilderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->mockFactory1
            ...
            ->willReturnCallback(fn(string $operation, array $options) => $operation == 'op1');
        ...
        $this->mockFactory2->expects($this->any())->method("supports")
            ->willReturnCallback(fn(string $operation, array $options) => $operation == 'op2');

        $this->chainBuilder = new ChainBuilder(new ExecutionContextFactory());
        $this->chainBuilder->registerFactory($this->mockFactory1);
        $this->chainBuilder->registerFactory($this->mockFactory2);
    }
